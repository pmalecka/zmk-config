...
# Get the date, branch name and short commit hash
...
echo 'tap-ms = <30>; // recommended value for BLE' >> "config/version.dtsi"
echo 'wait-ms = <30>;  // recommended value for BLE' >> "config/version.dtsi"
